...
namespace Congressus.Web
{
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        public async Task<ApplicationUser> CrearAutor(ApplicationUser user, string password)
        {
            await CreateAsync(user, password);
            user = await FindByEmailAsync(user.Email);
            var db = ApplicationDbContext.Create();
            db.Autores.Add(new Autor() { UsuarioId = user.Id });
            db.SaveChanges();
            return user;
        }
